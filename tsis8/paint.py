...
def draw_menu(size, color):
    pygame.draw.rect(screen, 'gray', [0,0,w, 90])#drawing menu
    pygame.draw.line(screen, 'black', (0,90), (w, 90), 2)
    ...
    #colors list
    blue = pygame.draw.rect(screen, (0,0,255), [w-45,20,25,25])
    red = pygame.draw.rect(screen, (255,0,0), [w-45,45,25,25])
    green = pygame.draw.rect(screen, (0,255,0), [w-70,20,25,25])
    yellow = pygame.draw.rect(screen, (255,255,0), [w-70,45,25,25])
    l_blue = pygame.draw.rect(screen, (0,255,255), [w-95,20,25,25])
    black = pygame.draw.rect(screen, (0,0,0), [w-95,45,25,25])
    eraser = pygame.draw.rect(screen, (255,255,255), [w-130,20,25,25])
